import{d as _,ac as d,I as p,b as a,e as t,x as s,z as r,F as u,ab as h,o as l,S as f,l as g,g as v}from"../modules/vue-CnJIpJLC.js";import{z as x,c as m,x as b,A as y,_ as N}from"../index-B06xYRGX.js";import{N as k}from"./NoteDisplay-CBFeieqG.js";import"../modules/shiki-BgDwwTVx.js";const w={id:"page-root"},L={class:"m-4"},S={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},z={class:"text-lg"},B={class:"font-bold flex gap-2"},D={class:"opacity-50"},H=t("div",{class:"flex-auto"},null,-1),A={key:0,class:"border-main mb-8"},C=_({__name:"print",setup(F){d(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
